(() => {
  ...
  function initDropdowns() {
    ...
    if (dropdowns.length) {
      dropdowns.forEach((dropdown) => {
        ...
        const container2 = dropdown.querySelector(
          '[data-js="dropdown-container"]'
        );
        if (!toggler || !container2)
          return;
        let dropdownExpanded = toggler.getAttribute("aria-expanded") === "true" || false;
        if (dropdownExpanded)
          toggleDropdown(true, toggler, container2);
        toggler.addEventListener("click", function() {
          toggleDropdown(!dropdownExpanded, toggler, container2);
  ...
  function toggleDropdown(expanded, btn, container2) {
    btn.setAttribute("aria-expanded", expanded);
    if (expanded) {
      container2.style.height = container2.scrollHeight + "px";
    } else {
      container2.style.removeProperty("height");
    }
  }
  ...
  var menuItemLinks = container.querySelectorAll(".menu-item a");
