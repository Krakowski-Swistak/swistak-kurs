						...
						if ( has_action( 'woocommerce_account_downloads_column_' . $column_id ) ) {
							...
							switch ( $column_id ) {
								case 'download-product':
									...
									break;
								case 'download-file':
									echo '<a href="' . esc_url( $download['download_url'] ) . '" class="woocommerce-MyAccount-downloads-file alt !bg-white px-4 py-3 !text-primary hover:!text-white !font-medium !rounded-2xl !border-2 !border-primary hover:!bg-primary !transition !duration-200 block">' . esc_html( $download['download_name'] ) . '</a>';
									break;
